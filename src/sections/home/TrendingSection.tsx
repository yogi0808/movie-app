...
import { endpointsForTrendingMovies } from '@constants/index';
...
const TrendingSection = () => {
  ...
  const { data, isLoading } = useFetchMovies(endpointsForTrendingMovies[activeTab]); // custom hook for data fetching return the data, error, and loading state
