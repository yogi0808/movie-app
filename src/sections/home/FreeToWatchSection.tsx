...
import { endpointsForFreeToWatchMovies } from '@constants/index';
...
const FreeToWatchSection = () => {
  ...
  const { data, isLoading } = useFetchMovies(endpointsForFreeToWatchMovies[activeTab]); // custom hook for data fetching return the data, error, and loading state
