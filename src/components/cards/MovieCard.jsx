...
import { MoviePopupLinks, statusColors } from "../../constants/index"
...
const MovieCard = ({ data, isLoading }) => {
  ...
  return (
    <div
      className={`max-w-37.5 relative flex flex-col content-stretch ${isLoading ? "animate-breath" : "animate-fade-in"}`}
    >
      <div
